...
from Graph_generate.ml1m_data_process import Ml1mDataset
from Graph_generate.ml1m_graph import Ml1mGraph
...
def main():
    ...
    parser.add_argument('--data_name', type=str, default=BOOK, choices=[LAST_FM_STAR, YELP_STAR,BOOK,AMAZON,ML1M],
